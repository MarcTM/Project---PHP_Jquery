...
function validate_create(){
    ...
    document.alta_product.submit();
    document.alta_product.action="index.php?page=controller_products&op=create";
}

function validate_da(){
    if (document.getElementById('del').value !== "CONFIRM"){
        document.getElementById('e_del').innerHTML = "Please type CONFIRM if you want to delete";
        return false;
    }
    if (document.getElementById('del').value === "CONFIRM"){
        document.getElementById('e_del').innerHTML = "";
        document.delete_allp.submit();
        document.delete_allp.action="index.php?page=controller_products&op=delete_all";
    }      
}